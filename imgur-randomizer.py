...
parser.add_argument('--name_length', type=int, choices=range(MIN_NAME_LENGTH, MAX_NAME_LENGTH+1), default=-1, help='file name length, 7-characters names are rare, so it’s better to use 5 or 6 (default: random)')
